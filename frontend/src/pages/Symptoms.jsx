          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {symptoms.map((symptom, index) => (
                <div key={index}>
                  <label
                    ...
                    className="block text-sm font-play font-medium bg-yellow text-gray-700"
                  >
                    Symptom {index + 1}:
                  </label>
                  <Autosuggest
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center py-2 px-4 font-play border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-one hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Submit Symptoms
                </button>
              </div>
