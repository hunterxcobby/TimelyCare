...
urlpatterns = [
    ...
    path('emergency-contacts/', views.emergency_contact, name='emergency_contacts'),
    path('emergency-contacts/<int:contact_id>/', views.emergency_contact, name='emergency_contact'),
